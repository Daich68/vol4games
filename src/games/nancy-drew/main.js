...
Посмертные Автоматические стихи, гадание или признание или улики. Поговорим позже. Экран чернеет.`,
  ...
  // 7 — финал
  `Когда ранней весной на деревьях появляются листья,
Я появляюсь на свет иначе.
Когда лебеди плывут по мерцающей голубой глади,
Я играю в летней росе.
Когда на осенний зов выходит олень,
Я по утрам протяжно кричу.
Когда приходит зима и птицы улетают,
Присоединяйся ко мне к долгому сну.

Пережить сплав по реке. Актёр: Что ты делаешь? Совершаешь непоправимую ошибку.`,
];
